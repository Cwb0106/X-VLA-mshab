...
| [`2toINF/X-VLA-Google-Robot`](https://huggingface.co/2toINF/X-VLA-Google-Robot)                    | Google Robot      | Aligned with large-scale Google Robot dataset for multi-skill generalization.                    | **80.4%(VM) 75.7%(VA)**        | [Simpler Eval](evaluation/simpler/README.md)   |
