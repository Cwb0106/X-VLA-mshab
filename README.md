...
| [`2toINF/X-VLA-AgiWorld-Challenge`](https://huggingface.co/2toINF/X-VLA-AgiWorld-Challenge)        | AgiWorld          | Fine-tuned for AgiWorld Challenge.       | **Champion🥇**        | -  |
| [`2toINF/X-VLA-Calvin-ABC_D`](https://huggingface.co/2toINF/X-VLA-Calvin-ABC_D)                    | CALVIN ABC_D      | Fine-tuned on CALVIN benchmark (ABC_D subset)              | **4.41**        | [Calvin Eval](evaluation/calvin/README.md)          |
...
| [`2toINF/X-VLA-Libero`](https://huggingface.co/2toINF/X-VLA-Libero)                                | LIBERO            | Fine-tuned on LIBERO benchmark                     | **98.1%**        | to be update         |
| [`2toINF/X-VLA-RoboTwin2`](https://huggingface.co/2toINF/X-VLA-RoboTwin2)                          | RoboTwin2         | Trained on RoboTwin2 dataset for dual-arm coordinated manipulation(50 demos for each task).                     | **70%**        | to be update |
...
| [`2toINF/X-VLA-SoftFold`](https://huggingface.co/2toINF/X-VLA-SoftFold)                            | SoftFold          | Fine-tuned on Soft-Fold Dataset. Specialized in deformable object manipulation (e.g., folding and cloth control).                 | cloth folding with a 100% success rate in 2 hours.  |  to be update   |
